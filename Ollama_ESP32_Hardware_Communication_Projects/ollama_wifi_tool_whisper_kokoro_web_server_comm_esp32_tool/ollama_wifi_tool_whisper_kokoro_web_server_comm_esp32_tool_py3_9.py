    ...
    if tool_calls:
        for tool in tool_calls:
            ...
            if fn_name in FUNCTION_MAP:
                ...
                say(f"Done, {fn_name.replace('_', ' ')}.")   # short — long TTS replies are painful
            else:
